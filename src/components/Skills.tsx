                        ...
                        skill.name === 'Next.js'
                            ?<div key={idx} className="inline-block px-4 md:px-10 text-center">
                                    <svg
                                        ...
                                        className="h-[4vh] w-auto mx-auto fill-text"
                                    >
                                        {nextjs}
                                    </svg>
                                    <p className="text-sm text-text mt-2">{skill.name}</p>
                                </div>
                            :<div key={idx} className="inline-block px-4 md:px-10 text-center">
                                    <Image
