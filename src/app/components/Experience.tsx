                ...
                return (
                    <div key={idx} className="flex flex-col md:flex-row w-[80vw] justify-between">
                        <motion.div
                            ...
                            <h2 className="text-lg text-start md:text-center font-quicksand">{experience.start} &mdash; {experience.end}</h2>
                        </motion.div>
                        <motion.div
                            initial={{ opacity: 0, x: 50 }}
                            animate={isInView ? { opacity: 1, x: 0 } : {}}
                            ...
                            <h2 className="text-lg font-quicksand">{experience.company}</h2>
                            <p className="mt-2 text-md">{experience.description}</p>
                        </motion.div>
                    </div>
                )
            })}
