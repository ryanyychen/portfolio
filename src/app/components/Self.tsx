        ...
        <div className="justify-items-center w-full min-h-[85vh]">
            <div className="flex flex-col md:flex-row items-center justify-items-center">
                ...
                <div className="flex flex-col items-center md:items-start justify-center w-full pl-2">
                    ...
                    <p className="text-lg md:text-xl text-center md:text-start mt-2 md:pr-[10vw]">I'm a Master's student studying Computer Science interested in developing cool software. I enjoy tinkering with new technology to create globally relevant solutions.</p>
